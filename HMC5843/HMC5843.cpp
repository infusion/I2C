 ...
 * @param dataRate
 */
void HMC5843::setDataRate(hmc5883l_datarate_t rate) {
 ...
 * @return 
 */
hmc5883l_datarate_t HMC5843::getDataRate() {
 ...
 * @param bias
 */
void HMC5843::setMeasureBias(hmc5883l_bias_t bias) {
 ...
 * @return 
 */
hmc5883l_bias_t HMC5843::getMeasureBias() {
 ...
 * @param gain
 */
void HMC5843::setGain(hmc5883l_gain_t gain) {
 ...
 * @return 
 */
hmc5883l_gain_t HMC5843::getGain() {
 ...
 * @param newMode
 */
void HMC5843::setMeasureMode(hmc5883l_mode_t newMode) {
 ...
 * @return 
 */
hmc5883l_mode_t HMC5843::getMeasureMode() {
